...
from pidal.err import ProgrammingError
from pidal.protocol.mysql.field_type import FieldType
...
decoders = {
    FieldType.BIT: convert_bit,
    FieldType.TINY: int,
    FieldType.SHORT: int,
    FieldType.LONG: int,
    FieldType.FLOAT: float,
    FieldType.DOUBLE: float,
    FieldType.LONGLONG: int,
    FieldType.INT24: int,
    FieldType.YEAR: int,
    FieldType.TIMESTAMP: convert_datetime,
    FieldType.DATETIME: convert_datetime,
    FieldType.TIME: convert_timedelta,
    FieldType.DATE: convert_date,
    FieldType.BLOB: through,
    FieldType.TINY_BLOB: through,
    FieldType.MEDIUM_BLOB: through,
    FieldType.LONG_BLOB: through,
    FieldType.STRING: through,
    FieldType.VAR_STRING: through,
    FieldType.VARCHAR: through,
